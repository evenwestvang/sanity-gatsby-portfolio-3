...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/81ikx7vg/settings/api) and create a token with read rights.
